 ...
 */
nitobi.treegrid.RowEventArgs = function(source, row)
{
	/**
	 * @private
	 */
 ...
 */
nitobi.treegrid.RowEventArgs.prototype.getSource = function()
{
	return this.grid;
}
/**
 ...
 */
nitobi.treegrid.RowEventArgs.prototype.getRow = function()
{
	return this.row;
}
/**
 ...
 * @private
 */
nitobi.treegrid.RowEventArgs.prototype.getEvent = function()
{
	return this.event;
}
