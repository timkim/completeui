 ...
 * @private
 */
nitobi.treegrid.OnBeforeCellEditEventArgs = function(source, cell)
{
	nitobi.treegrid.OnBeforeCellEditEventArgs.baseConstructor.call(this, source, cell);
}

nitobi.lang.extend(nitobi.treegrid.OnBeforeCellEditEventArgs, nitobi.treegrid.CellEventArgs);