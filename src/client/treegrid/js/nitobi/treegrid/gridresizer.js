 ...
 * @private
 */
nitobi.treegrid.GridResizer = function(grid)
{
	this.grid = grid;
 ...
 * @private
 */
nitobi.treegrid.GridResizer.prototype.startResize = function(grid, event)
{
	this.grid = grid;

	var beforeGridResizeEventArgs = null; //new nitobi.treegrid.OnBeforeGridResizeEventArgs(this.grid);
 ...
 * @private
 */
nitobi.treegrid.GridResizer.prototype.resize = function()
{
	var x = this.dd.x;
	var y = this.dd.y;
 ...
 * @private
 */
nitobi.treegrid.GridResizer.prototype.endResize = function()
{
	var x = this.dd.x;
	var y = this.dd.y;
 ...
 * @private
 */
nitobi.treegrid.GridResizer.prototype.dispose = function()
{
	this.grid = null;
}
