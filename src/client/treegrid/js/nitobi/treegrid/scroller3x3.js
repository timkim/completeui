...
/**
 * @class nitobi.treegrid.Scroller3x3
 * @constructor
 * @private
 */
nitobi.treegrid.Scroller3x3 = function(owner,height,rows,columns,freezetop,freezeleft) {
	this.disposal = [];
	/**
	 * The html element that this Scroller represents.  Gets defined in
	 * nitobi.treegrid.Scroller3x3#mapToHtml
	 * @private
	 */
	this.htmlNode;
	this.height = height;
	 ...
	 * @private
	 */
	this.surface = new nitobi.treegrid.Surface(this, this.owner, "0");
 ...
 */
nitobi.treegrid.Scroller3x3.prototype.updateCellRanges= function(cols,rows,frzL,frzT) {
	this.columns = cols;
	this.rows = rows;
	this.freezetop = frzT;
...
nitobi.treegrid.Scroller3x3.prototype.setCellRanges= function() {
	var pageSize = null;
...
nitobi.treegrid.Scroller3x3.prototype.resize=function(height) {
	this.height = height;
}
nitobi.treegrid.Scroller3x3.prototype.setScrollLeftRelative=function(offset) {
	this.setScrollLeft(this.scrollLeft+offset);
}
nitobi.treegrid.Scroller3x3.prototype.setScrollLeftPercent=function(scrollPercent) {
...
nitobi.treegrid.Scroller3x3.prototype.setScrollLeft=function(scrollLeft) {
...
nitobi.treegrid.Scroller3x3.prototype.getScrollLeft=function() {
	return this.scrollSurface.scrollLeft;
}
nitobi.treegrid.Scroller3x3.prototype.setScrollTopRelative=function(offset) {
	this.setScrollTop(this.getScrollTop()+offset);
}
nitobi.treegrid.Scroller3x3.prototype.setScrollTopPercent=function(scrollPercent) {
...
nitobi.treegrid.Scroller3x3.prototype.getScrollTopPercent = function(){
...
nitobi.treegrid.Scroller3x3.prototype.setScrollTop=function(scrollTop) {
	this.surface.view.midcenter.element.scrollTop = scrollTop;
	this.surface.view.midleft.element.scrollTop = scrollTop;
	this.render();
}
nitobi.treegrid.Scroller3x3.prototype.getScrollTop=function() {
	return this.scrollSurface.scrollTop;
}

nitobi.treegrid.Scroller3x3.prototype.clearSurface = function(ClearAll,ClearTop,ClearMiddle,ClearBottom, surfaceKey)
{
...
nitobi.treegrid.Scroller3x3.prototype.mapToHtml=function(oNode)
{
 ...
 */
nitobi.treegrid.Scroller3x3.prototype.render=function(force)
{
 ...
 */
nitobi.treegrid.Scroller3x3.prototype.performRender=function()
{
 ...
 * The actual render operation
 */
nitobi.treegrid.Scroller3x3.prototype.renderGap = function(low,high)
{
	this.surface.renderGap(low, high);
}
// TODO: This is different from flushCache that used to call flushCache in viewport
nitobi.treegrid.Scroller3x3.prototype.flushCache = function()
{
	if (Boolean(this.surface.cacheMap)) this.surface.cacheMap.flush();
}
nitobi.treegrid.Scroller3x3.prototype.reRender= function(startRow, endRow)
{
	this.surface.reRender(startRow, endRow);
}
nitobi.treegrid.Scroller3x3.prototype.getViewportByCoords=function(row, column, surfacePath) 
{
...
nitobi.treegrid.Scroller3x3.prototype.getRowsPerPage=function() {
	return this.owner.getRowsPerPage();
}
nitobi.treegrid.Scroller3x3.prototype.getDisplayedRowCount=function() {
	return this.owner.getDisplayedRowCount();
}
nitobi.treegrid.Scroller3x3.prototype.getCurrentPageIndex=function() {
	return this.owner.getCurrentPageIndex();
}
nitobi.treegrid.Scroller3x3.prototype.implementsStandardPaging = function() {
...
nitobi.treegrid.Scroller3x3.prototype.implementsShowAll = function() {
	return Boolean(this.owner.getPagingMode().toLowerCase() == nitobi.treegrid.PAGINGMODE_NONE);
}
nitobi.treegrid.Scroller3x3.prototype.setDataTable = function(oDataTable) 
{
...
nitobi.treegrid.Scroller3x3.prototype.getDataTable = function() {
	return this.dataTable;
}

nitobi.treegrid.Scroller3x3.prototype.handleHtmlReady = function()
{
	this.onHtmlReady.notify();
}

nitobi.treegrid.Scroller3x3.prototype.getTop = function() {
	return this.freezetop * this.rowHeight + this.headerHeight;
}

nitobi.treegrid.Scroller3x3.prototype.setRowHeight = function(rowHeight)
{
	this.rowHeight = rowHeight;
	this.setViewportProperty("RowHeight", rowHeight);
}
nitobi.treegrid.Scroller3x3.prototype.setHeaderHeight = function(headerHeight)
{
	this.headerHeight = headerHeight;
	this.setViewportProperty("HeaderHeight", headerHeight);
}
nitobi.treegrid.Scroller3x3.prototype.setViewportProperty = function(property, value)
{
	this.surface.setViewportProperty(property, value);
}
nitobi.treegrid.Scroller3x3.prototype.fire= function(evt,args){
	return nitobi.event.notify(evt+this.uid,args);
}
nitobi.treegrid.Scroller3x3.prototype.subscribe= function(evt,func,context)  {
	if (typeof(context)=="undefined") context=this;
	return nitobi.event.subscribe(evt+this.uid,nitobi.lang.close(context, func));
}

nitobi.treegrid.Scroller3x3.prototype.createRenderers = function(data) 
{
 ...
 * @type nitobi.treegrid.Surface
 */
nitobi.treegrid.Scroller3x3.prototype.getSurface = function(path)
{
	if (path == null) {
		return null;
	}
...
nitobi.treegrid.Scroller3x3.prototype.purgeSurfaces = function()
{
	this.surface.purgeSurfaces();
}

nitobi.treegrid.Scroller3x3.prototype.getSurfacesByColSet = function(colset)
{
	var result = [];
...
nitobi.treegrid.Scroller3x3.prototype.isColSetVisible = function(colset)
{
...
nitobi.treegrid.Scroller3x3.prototype.resetHeaders = function()
{
	this.surface.checkHeaders();
}

nitobi.treegrid.Scroller3x3.prototype.dispose = function()
{
	try
	{
