 ...
 * @private
 */
nitobi.treegrid.OnCellFocusEventArgs = function(source, cell)
{
	nitobi.treegrid.OnCellFocusEventArgs.baseConstructor.call(this, source, cell);
}

nitobi.lang.extend(nitobi.treegrid.OnCellFocusEventArgs, nitobi.treegrid.CellEventArgs);