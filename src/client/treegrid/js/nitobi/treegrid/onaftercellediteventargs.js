 ...
 * @private
 */
nitobi.treegrid.OnAfterCellEditEventArgs = function(source, cell)
{
	nitobi.treegrid.OnAfterCellEditEventArgs.baseConstructor.call(this, source, cell);
}

nitobi.lang.extend(nitobi.treegrid.OnAfterCellEditEventArgs, nitobi.treegrid.CellEventArgs);