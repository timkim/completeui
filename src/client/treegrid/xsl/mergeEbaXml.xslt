...
<xsl:stylesheet version="1.0" 
	...
	<xsl:key name="newData" match="/ntb:treegrid/ntb:newdata/ntb:data/ntb:e" use="@xi" />
	<xsl:key name="oldData" match="/ntb:treegrid/ntb:datasources/ntb:datasource/ntb:data/ntb:e" use="@xi" />
	...
	<xsl:template match="/ntb:treegrid/ntb:newdata/ntb:data/ntb:e">
		<xsl:copy>
			<xsl:copy-of select="@*" />
